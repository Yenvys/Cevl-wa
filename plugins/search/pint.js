...
export default {
  ...
  async exec(m, { sock, args, command }) {
    const chatId = m.from;
    ...
    try {
      ...
      const carousel = await buildCarouselMessage(
        sock,
        m.from,
        selectedPins,
        query,
