...
export async function saveMetadata(jid, name, desc, participants = []) {
    ...
    await syncParticipants(jid, participants);
}

export async function syncParticipants(jid, participants = []) {
    ...
    try {
        ...
        for (const p of participants) {
            ...
            if (userJid) await saveContact(userJid, userLid, null);
        }
